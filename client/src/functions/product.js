...
export const fetchProductsByFilter= async (arg)=>{
 ...
 export const getAllProds=async ()=>{
  return await axios.get(`${process.env.REACT_APP_API}/products/all`,)
 }

 export const getProductsBasedOnCategory = async(categoryId)=>{
  return await axios.get(`${process.env.REACT_APP_API}/products/category/${categoryId}`,)
